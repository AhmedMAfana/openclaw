...
WELCOME_TEXT = (
    "⚡ <b>OpenClow</b> — AI Dev Orchestrator\n"
    "━━━━━━━━━━━━━━━━━━━━━━━\n\n"
    "I automate development tasks on your\n"
    "projects using Claude Code agents.\n\n"
...
HELP_TEXT = (
    "📖 <b>Commands</b>\n"
    "━━━━━━━━━━━━━━━━━━━━━━━\n\n"
    "🚀 <b>/task</b> — Submit a development task\n"
    "📂 <b>/projects</b> — List connected projects\n"
    "📊 <b>/status</b> — Show running tasks\n"
    "📈 <b>/dashboard</b> — Live monitoring dashboard\n"
    "⚙️ <b>/settings</b> — Settings dashboard (web UI)\n"
    "🔄 <b>/cancel</b> — Cancel a running task\n\n"
    "<b>Project Management</b>\n"
    "▶️ <b>/dockerup</b> — Start Docker containers\n"
    "⏹ <b>/dockerdown</b> — Stop Docker containers\n"
    "🔄 <b>/bootstrap</b> — Re-setup project environment\n\n"
    "<b>Admin</b>\n"
    "➕ <b>/addproject</b> — Connect a GitHub repo\n"
    "👤 <b>/adduser</b> — Authorize a user\n"
    "🗑 <b>/removeproject</b> — Remove a project\n"
...
async def menu_main(callback: CallbackQuery):
    await _safe_edit_or_send(callback, WELCOME_TEXT, main_menu_keyboard(), "HTML")
...
async def menu_task(callback: CallbackQuery, state: FSMContext):
    ...
    from openclow.bot.keyboards import project_keyboard
...
async def menu_addproject(callback: CallbackQuery):
    ...
    from openclow.bot.handlers.admin import _build_repo_keyboard
...
async def menu_projects(callback: CallbackQuery):
    ...
    buttons = []
    for p in projects:
        label = f"{'🟢' if p.is_dockerized else '⚪'} {p.name} — {p.tech_stack or 'N/A'}"
...
async def project_detail(callback: CallbackQuery):
    ...
    status_label = "🟢 Active" if getattr(project, "status", "active") == "active" else "🔴 Unlinked"
    text = (
    ...
    is_active = getattr(project, "status", "active") == "active"

    if is_active:
        buttons = [
            [
                InlineKeyboardButton(text="💚 Health Check", callback_data=f"health:{project_id}"),
                InlineKeyboardButton(text="🔄 Bootstrap", callback_data=f"project_bootstrap:{project_id}"),
            ],
        ]
        # Only show Docker buttons if project is dockerized
