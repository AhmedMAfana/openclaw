...
from openclow.api.routes.access import _require_admin
...
from openclow.services import audit_service
...
async def admin_rotate_token(
    ...
    try:
        from openclow.worker.tasks.instance_tasks import rotate_github_token
