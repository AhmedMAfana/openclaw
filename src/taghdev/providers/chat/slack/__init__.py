...
from taghdev.providers.base import ChatProvider
from taghdev.providers.registry import register_chat
from taghdev.utils.logging import get_logger

if TYPE_CHECKING:
    from taghdev.providers.actions import ActionKeyboard
...
class SlackProvider(ChatProvider):
    ...
    def _build_blocks(text: str, keyboard: ActionKeyboard | None = None) -> list[dict]:
        from taghdev.providers.chat.slack.blocks import build_message_blocks, status_update_blocks, translate_keyboard
    ...
    async def send_plan_preview(
        ...
        from taghdev.providers.chat.slack.blocks import plan_preview_blocks
    ...
    async def send_progress(
        ...
        from taghdev.providers.chat.slack.blocks import progress_blocks
    ...
    async def send_summary(
        ...
        from taghdev.providers.chat.slack.blocks import summary_blocks
    ...
    async def send_diff_preview(
        ...
        from taghdev.providers.chat.slack.blocks import diff_preview_blocks
    ...
    async def send_pr_created(
        ...
        from taghdev.providers.chat.slack.blocks import pr_created_blocks
    ...
    async def send_error(self, chat_id: str, message_id: str | None, text: str) -> None:
        from taghdev.providers.chat.slack.blocks import error_blocks
    ...
    async def send_terminal_message(self, chat_id: str, message_id: str | None, text: str) -> None:
        from taghdev.providers.chat.slack.blocks import terminal_blocks
    ...
    async def publish_home_tab(self, user_id: str) -> None:
        ...
        client = self._get_client()
        from taghdev.providers.chat.slack.handlers.home import publish_home
    ...
    async def start_bot(self) -> None:
        ...
        from taghdev.providers.chat.slack.handlers import commands, actions, events, modals, home
