...
class TelegramProvider(ChatProvider):
    ...
    async def send_plan_preview(
        ...
        from aiogram.types import InlineKeyboardButton, InlineKeyboardMarkup
        from taghdev.utils.messaging import plan_preview_message
    ...
    async def send_progress(
        ...
        from taghdev.utils.messaging import progress_message
    ...
    async def send_summary(
        ...
        from aiogram.types import InlineKeyboardButton, InlineKeyboardMarkup
        from taghdev.utils.messaging import task_complete_message
    ...
    async def send_pr_created(
        ...
        from aiogram.types import InlineKeyboardButton, InlineKeyboardMarkup
        from taghdev.utils.messaging import pr_created_message
    ...
    async def start_bot(self) -> None:
        ...
        from taghdev.providers.chat.telegram.handlers import start, task, review, admin, chat
        from taghdev.providers.chat.telegram.middlewares.auth import AuthMiddleware
