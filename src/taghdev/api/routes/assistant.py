...
from taghdev.services.access_service import get_accessible_projects_for_mcp, is_tool_allowed
from taghdev.worker.tasks.agent_session import _build_context
...
from taghdev.services.instance_lock import instance_lock
from taghdev.services.stream_validator import validate_event as _validate_stream_event
    ...
    async def run(controller: RunController):
        try:
            ...
            if _cmd.startswith("end_session_confirm:"):
                ...
                from taghdev.models.instance import Instance as _Instance, InstanceStatus as _IS
            ...
            if resolved_project_id:
                from taghdev.models.project import Project as _Project
                async with async_session() as _db:
                                    ...
                                    if isinstance(message.content, list):
                                        for block in message.content:
                                            if isinstance(block, ToolResultBlock):
                                                ...
                                                from taghdev.services.audit_service import redact as _redact_chat
                                                controller.add_data({
                                                    "type": "tool_result",
