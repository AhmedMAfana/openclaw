...
async def docker_up_task(ctx: dict, project_id: int, chat_id: str, message_id: str, chat_provider_type: str = "telegram"):
    ...
    """
    from taghdev.worker.tasks.health_task import check_project_health
...
async def docker_down_task(ctx: dict, project_id: int, chat_id: str, message_id: str, chat_provider_type: str = "telegram"):
    ...
    try:
        ...
        if not project:
            from taghdev.providers.actions import nav_keyboard
        ...
        try:
            from taghdev.services.tunnel_service import get_tunnel_url as _get_tunnel_url
        ...
        from taghdev.services.docker_guard import run_docker as _run
