...
async def sync_project_tunnel(service_name: str, tunnel_url: str):
    ...
    import re as _re
    import shlex
    from taghdev.settings import settings as app_settings
    ...
    compose_project = f"taghdev-{service_name}"
    ...
    try:
        from taghdev.services.docker_guard import run_docker as _check_docker
